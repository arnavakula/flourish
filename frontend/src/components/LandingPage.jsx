            ...
            <div ref={forwardRef} id='home' className='h-fit text-[#285a34] font-semibold font-raleway text-center '>
                ...
                <div className='h-full flex flex-col items-center mt-[6vh] '>
                    ...
                    <div className='flex gap-[4vw]'>
                        <Link to='/register' >
                            <button onClick={() => scrollToSection('about')} className='w-[35vw] h-[5vh] text-white rounded-lg mt-[2vh] border-2 hover:opacity-90 bg-[#285a34] border-slate-800 flex gap-[1vw] justify-center items-center shadow-md'>
                                <h2>Get Started</h2>
                                <ArrowForwardRoundedIcon className='scale-90' fontSize='small' />
                            </button>
                        </Link>
                        <button onClick={() => scrollToSection('about')} className='w-[30vw] h-[5vh] rounded-lg mt-[2vh] border-2  bg-[#2D2327] border-slate-800 flex justify-center items-center shadow-md'>
